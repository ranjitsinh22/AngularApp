...
@Component({
  selector: 'app-subject-assign-comp2',
  templateUrl: './subject-assign-comp2.component.html',
  styleUrls: ['./subject-assign-comp2.component.css']
})
export class SubjectAssignComp2Component implements OnInit {
